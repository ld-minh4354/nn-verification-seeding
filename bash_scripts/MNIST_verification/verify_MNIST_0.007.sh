#!/bin/bash
#SBATCH --job-name=verify_MNIST_0.007
#SBATCH --gpus=nvidia_h100_80gb_hbm3_2g.20gb:1
#SBATCH --cpus-per-task=1
#SBATCH --mem=61G
#SBATCH --time=3:00:00
#SBATCH --array=0-449
#SBATCH --output=logs/verify_MNIST_0.007_%a.out
...
for (( X=0; X<20; X++ )); do
...

    {
        ...
        --config $HOME/eml-verification/properties/MNIST_${EPSILON}_${SLURM_ARRAY_TASK_ID}.yaml
