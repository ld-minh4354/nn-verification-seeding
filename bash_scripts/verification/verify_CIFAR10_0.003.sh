#!/bin/bash
#SBATCH --job-name=verify_CIFAR10_0.003
#SBATCH --gpus=nvidia_h100_80gb_hbm3_2g.20gb:1
#SBATCH --cpus-per-task=1
#SBATCH --mem=61G
#SBATCH --time=3:00:00
#SBATCH --array=0-449
#SBATCH --output=logs/CIFAR10_0.003_%a.out
...
for (( X=0; X<20; X++ )); do
    ...
    LOGFILE="logs_verification/CIFAR10_${EPSILON}_${ID}.out"

    {
        srun python code/property_gen/generate_property_CIFAR10.py \
